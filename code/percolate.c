...
void function1(int length, float rho, int **map);
void function2(int length, int **map);
void function3(int length, int **map);
void function4(int length, int **map, int maxClusters, char *datFile, char *pgmFile);
...
int main(int argc, char *argv[]) {
    ...
    function1(length, rho, map);

    function2(length, map);

    function3(length, map);

    function4(length, map, maxClusters, datFile, pgmFile);
